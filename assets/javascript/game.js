...
function startGame() {
    ...
    $(enemyChar1).click(function () {
        enemyClicked1 = true;
        // CLICKEDENEMIES.PUSH(ENEMYCHAR1)
        $(enemyChar2).remove();
        $(enemyChar3).remove();
        $(enemyChar4).remove();
        $(enemyChar5).remove();
...
var chooseNewOpponent = () => {
    ...
    if (enemyClicked1) {
        ...
        clickedEnemies.push(enemyChar2);
        opponentHP = Math.floor(Math.random() * 250);
        enemyAttackPower = Math.floor(Math.random() * 101);
        userAttackPower += Math.floor(Math.random() * 50);
        $(".enemies").append(enemyChar1);
        ...
        clickedEnemies.push(enemyChar3);
        opponentHP = Math.floor(Math.random() * 250);
        enemyAttackPower = Math.floor(Math.random() * 101);
        userAttackPower += Math.floor(Math.random() * 50);
        $(".enemies").append(enemyChar1);
        ...
        clickedEnemies.push(enemyChar4);
        opponentHP = Math.floor(Math.random() * 250);
        enemyAttackPower = Math.floor(Math.random() * 101);
        userAttackPower += Math.floor(Math.random() * 50);
        $(".enemies").append(enemyChar1);
        ...
        clickedEnemies.push(enemyChar5);
        opponentHP = Math.floor(Math.random() * 250);
        enemyAttackPower = Math.floor(Math.random() * 101);
        userAttackPower += Math.floor(Math.random() * 50);
        $(".enemies").append(enemyChar1);
